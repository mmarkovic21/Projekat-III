...
<div class="container  p-4">
  ...
  <div class="row justify-content-center p-5 mt-4">
    <div class="col-3 m-2">
    <a href="Usluge/dodajUslugu.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Dodaj uslugu</a>
    </div>
    <div class="col-3 m-2">
    <a href="Usluge/izmeniUslugu.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Izmeni uslugu</a>
    </div>
    <div class="col-3 m-2">
    <a href="Usluge/obrisiUslugu.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Obriši uslugu</a>
    </div>
  </div>
